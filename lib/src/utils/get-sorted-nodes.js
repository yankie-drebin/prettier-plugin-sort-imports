...
var getSortedNodes = function (nodes, options) {
    ...
    importOrder.forEach(function (group, index) {
        ...
        var addNewLine = (importOrderSeparation === null || importOrderSeparation === void 0 ? void 0 : importOrderSeparation.includes(index + 1)) ||
